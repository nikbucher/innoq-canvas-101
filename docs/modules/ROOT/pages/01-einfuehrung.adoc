...
* *xref:02-01-business-model.adoc[Business Model Canvas]:* Sicherlich *_der_* Canvas schlechthin: Der klassische Steckbrief für Geschäfts- oder Business-Modelle.
* *xref:02-02-architecture-inception.adoc[Architecture Inception Canvas]:* Der solide Start in IT-Vorhaben, von einem Überblick der Anforderungen zu ersten Lösungsideen.
* *xref:02-03-architecture-communication.adoc[Architecture Communication Canvas]:* Architekturdokumentation in Kurzform, passend zu arc42.
...
image::figure-001.png[Inhaltlicher Zusammenhang der Canvases]
...
* *Erst die Inhalte, dann die Werkzeuge*: Statt lange über das passende Werkzeug zu diskutieren, sollten Sie sich um die Inhalte Ihres Canvas kümmern. Wir haben ein Kapitel zu xref:03-tools.adoc[Werkzeugen] aufgenommen und stellen einige unserer Favoriten vor.
