...
.Software Analytics Canvas
image::figure-017.png[Software Analytics Canvas]
...
_Welche Daten können unsere Frage möglicherweise beantworten?
Welche Informationen benötigen wir?_
...
image::figure-018.png[Software Analytics Canvas Beispiel]
