...
.Architecture Inception Canvas
image::figure-005.png[Architecture Inception Canvas]
...
image::figure-006.png[Die drei Hauptbereiche des AIC]
...
Idealerweise nutzen Sie diese ersten Architekturannahmen, um erste Entwürfe von Architecture Decision Records (ADR) zu erstellen. So können Sie die initialen Architekturentscheidungen Ihres Softwareprodukts dokumentieren und im Team finalisieren.
...
image::figure-007.png[Kapitel des arc42-Templates im AIC]
...
image::figure-008.png[Ausschnitt einer ersten Iteration mit dem AIC]
