...
Eines unserer favorisierten Werkzeuge zum informellen Arbeiten an einem Canvas.
Papier hat diverse Nachteile (schlecht änderbar, nicht automatisch durchsuchbar, begrenzte Fläche, geringe Haltbarkeit, empfindlich gegenüber Kaffeeflecken...), jedoch auch bestechende Vorteile:
...
* https://www.drawio.com[draw.io] ist vermutlich das bekannteste Zeichenwerkzeug heutzutage.
Sie finden für einige der hier vorgestellten Canvases bereits Templates für draw.io.
* Visio, OmniGraffle oder Photoshop, letztlich können Sie jedes beliebige Zeichenwerkzeug verwenden, mit dem Sie zurechtkommen.
Sie müssen nur darauf achten, dass alle Beteiligten die jeweiligen Werkzeuge zur Verfügung haben.
...
* https://canvanizer.com/[Canvanizer], ein Start-up, das kollaborative Erstellung und Pflege von Canvases erlaubt.
Einige Features können Sie in einer freien Version verwenden, für fortgeschrittene Aufgaben benötigen Sie ein Abo.
...
* https://www.drawio.com[draw.io]-Plugin für https://www.atlassian.com/software/confluence[Confluence].
So haben Sie die Möglichkeit, in einem Ihnen bekannten Zeichenwerkzeug kollaborativ zu arbeiten – eine ideale Lösung, wenn Sie bereits Confluence in Ihrer Firma einsetzen.
