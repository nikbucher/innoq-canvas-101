...
.Architecture Communication Canvas
image::img/figure-009.png[Architecture Communication Canvas]
...
image::img/figure-010.png[Business Context des ACC]
...
.ACC Components / Modules
image::img/figure-011.png[ACC Components / Modules]
...
image::img/figure-012.png[ACC als Einstieg in umfangreichere arc42 Dokumentation]
...
image::img/figure-013.png[ACC für Microservices]
...
image::img/figure-014.png["Sonstiges" als Platzhalter im Diagramm]
...
image::img/figure-015.png[ACC von status.arc42.org]
