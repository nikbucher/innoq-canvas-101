...
.Architecture Inception Canvas
image::img/figure-005.png[Architecture Inception Canvas]
...
image::img/figure-006.png[Die drei Hauptbereiche des AIC]
...
image::img/figure-007.png[Kapitel des arc42-Templates im AIC]
...
image::img/figure-008.png[Ausschnitt einer ersten Iteration mit dem AIC]
